...
**Workflow**: Collected and prepared time series data,Visualised returns and volatility patterns,Tested for heteroskedasticity
Built ARCH and GARCH models,Compared model outputs and interpretations
**Key Takeaways** : Volatility clustering is very evident in financial data,ARCH models capture short-term effects
